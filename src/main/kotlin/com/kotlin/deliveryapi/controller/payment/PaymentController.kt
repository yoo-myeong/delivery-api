package com.kotlin.deliveryapi.controller.payment

import com.kotlin.deliveryapi.controller.order.dto.OrderRequest
import com.kotlin.deliveryapi.controller.payment.dto.PayRequest
import com.kotlin.deliveryapi.controller.payment.dto.PayResponse
import com.kotlin.deliveryapi.service.order.OrderService
import com.kotlin.deliveryapi.service.payment.PaymentService
...
class PaymentController(
    ...
    @Operation(
        summary = "주문서 결제하는 API",
        description = "주문서 결제를 처리하는 API",
    )
    fun pay(
